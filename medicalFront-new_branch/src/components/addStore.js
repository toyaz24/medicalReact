                                ...
                                <div className = "card-body">
                                    ...
                                    <form>
                                        ...
                                        <div className="col-5" className = "form-group">
                                            ...
                                            <div className="row">
                                                <div className="col-6">
                                                <label for='retailDrug'>Retail Drug License</label>
                                                ...
                                                <div className="col-6">
                                                        <label for='wholesale'>Wholesale Drug Licence</label>
                                        ...
                                        storeTypeId
                                            ...
                                            { <select className="form-control" name="storeTypeId" onChange={this.changeEmailHandler} value={this.state.storeTypeId}>
                                            {
